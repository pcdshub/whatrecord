...
# Generated using: pytmc 2.13.0+15.g35cceb1
# Project version: dbcc588
#    Project hash: dbcc58890e6511f8db291b972aa13b8cdbd2ae09
...
epicsEnvSet("ADS_MAX_PARAMS",   "10217")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:LFE:MOTION,PROJECT=plc-lfe-motion.tsproj,HASH=dbcc588,VERSION=dbcc588,PYTMC=2.13.0+15.g35cceb1,PLC_HOST=172.21.88.228")
...
#   PMPS: * -> 2.2.0 (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:LFE:MOTION,DEPENDENCY=PMPS,VERSION=2.2.0,VENDOR=SLAC - LCLS")
#   Tc2_MC2: * (Beckhoff Automation GmbH)
...
# Total records: 9217
callbackSetQueueSize(20434)

# Load user-specified database: a
dbLoadRecords("a", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:MOTION:,IOCNAME=$(IOC),IOC=$(IOC)")
# Load user-specified database: b
dbLoadRecords("b", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:MOTION:,IOCNAME=$(IOC),IOC=$(IOC)")
# Load user-specified database: c
dbLoadRecords("c", "PORT=$(ASYN_PORT),PREFIX=PLC:LFE:MOTION:,IOCNAME=$(IOC),IOC=$(IOC)")
